...
#  include "vectopt_loop_substitute.h90"
   ...
   !! $Id: dynspg_ts.F90 11536 2019-09-11 13:54:18Z smasson $
...
!jth do implicitly instead
         ...
         IF( .NOT.ln_linssh ) THEN   !* Update ocean depth (variable volume case only)
            ...
            CALL lbc_lnk_multi( 'dynspg_ts', hu_e , 'U', 1._wp, hv_e , 'V', 1._wp  &
                 &                         , hur_e, 'U', 1._wp, hvr_e, 'V', 1._wp  )
         ENDIF
         !
         IF ( ll_wd ) THEN ! revert to explicit for bit comparison tests in non
            DO jj = 2, jpjm1
               DO ji = fs_2, fs_jpim1   ! vector opt.
